...
host = 'search-es-test-kbm2rqftfn5wszkzecupuvlive.ap-southeast-2.es.amazonaws.com'
...
es.index(index="movies", doc_type="doc", id=5, body=movie)
print(es.get(index="movies", doc_type="doc", id=5))
